export default function AboutPage() {
	return (
		<div className="container mx-auto px-4 py-8">
			<h1 className="text-3xl font-bold mb-6">About Vanish Club</h1>
			<div className="prose max-w-none">
				<p className="mb-4">
					Vanish Club is a secure marketplace platform that prioritizes user privacy and security in digital transactions.
				</p>
